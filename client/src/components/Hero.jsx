  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
        <div className='text-center mb-6'>
            <h1 className='text-3x1 sm:text-5x1 md:text-6x1 2xl:text-7xl font-semibold mx-auto leading-[1.2]'> Create amazing content <br/> with <span className='text-primary'>  AI tools </span> </h1>
        ...
        <div className='flex flex-wrap justify-center items-center gap-5 text-sm mx-sm:text-xs'>
            ...
            <button onClick={() => navigate('/')} className='bg-primary text-black px-10 py-2.5 rounded-lg hover:scale-102 active:scale-96 transition cursor-pointer'>Watch demo</button>
        </div>
