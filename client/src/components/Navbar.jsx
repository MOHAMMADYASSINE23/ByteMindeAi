...
const Navbar = () => {
  ...
  return (
    <div className='fixed z-5 w-full backdrop-blur-2xl flex justify-between items-center px-4 py-3 sm:px-20 lg:px-32'>
        <img src={assets.logo} alt="logo" className='w-32 sm:w-42 cursor-pointer' onClick={() => navigate('/')} />
